...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20231026041750_notification")]
            ...
            modelBuilder.Entity("Entities.DataModels.ClinicalEnhancement", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(381), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(382), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2L,
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(388), new TimeSpan(0, 0, 0, 0, 0)),
                            IsQuestionMandatory = false,
                            LevelOfQuestion = (byte)1,
                            Question = "Have you ever been hospitalized for any reason?",
                            TypeOfQuestion = (byte)1,
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(388), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3L,
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(390), new TimeSpan(0, 0, 0, 0, 0)),
                            IsQuestionMandatory = false,
                            LevelOfQuestion = (byte)1,
                            ...
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(390), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4L,
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(391), new TimeSpan(0, 0, 0, 0, 0)),
                            IsQuestionMandatory = true,
                            LevelOfQuestion = (byte)1,
                            Options = "Child,Teenager,Adult,Senior Citizen",
                            Question = "What is your age group?",
                            TypeOfQuestion = (byte)4,
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(392), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5L,
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(393), new TimeSpan(0, 0, 0, 0, 0)),
                            IsQuestionMandatory = false,
                            LevelOfQuestion = (byte)1,
                            Question = "Have you ever been diagnosed with mental health conditions, such as depression or anxiety?",
                            TypeOfQuestion = (byte)1,
                            UpdatedOn = new DateTimeOffset(new DateTime(2023, 10, 26, 4, 17, 49, 771, DateTimeKind.Unspecified).AddTicks(393), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
